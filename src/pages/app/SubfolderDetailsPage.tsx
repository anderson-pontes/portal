            ...
            <div className="flex justify-between">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => navigate(`/folder/${folderId}/${subfolderId}/create`)}>Criar Pasta</DropdownMenuItem>
                        <DropdownMenuItem onClick={() => navigate(`/folder/${folderId}/manage`)}>Criar Arquivo</DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>
